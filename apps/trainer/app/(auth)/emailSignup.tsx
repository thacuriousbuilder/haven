...
import { validatePassword } from '@haven/shared-utils/utils/passwordValidation';
import { sanitizeInput } from '@haven/shared-utils/utils/sanitize';
...
export default function EmailSignup() {
  ...
  async function handleSignUp() {
    ...
    if (data.user || data.session) {
      router.replace('/(onboarding)/educationOne');
    }
  }
