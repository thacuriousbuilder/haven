  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Manage Treat Days</Text>
      ...
      <View style={styles.summaryCard}>
        ...
        <View style={styles.summarySection}>
          <Text style={styles.summaryLabel}>Treat Days</Text>
      ...
      {cheatDays.length === 0 ? (
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyText}>No upcoming treat days planned</Text>
          ...
          >
            ...
            <Text style={styles.emptyAddButtonText}>Plan Your First treat Day</Text>
          </TouchableOpacity>
        </View>
     ) : (
      <FlatList
        ...
        ListHeaderComponent={
          <Text style={styles.sectionTitle}>UPCOMING TREAT DAYS</Text>
        }
      />
    )}
    </SafeAreaView>
